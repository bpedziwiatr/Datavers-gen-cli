...
#region Wrappers and Templates
	...
	private static readonly Lazy<Regex> ColorBlockRegEx = new(ColorBlockRegExCompiled,
		true);
...
#region Success, Error, Info, Warning Wrappers
	...
	[GeneratedRegex("\\[(?<color>.*?)\\](?<text>[^[]*)\\[/\\k<color>\\]", RegexOptions.IgnoreCase, "pl-PL")]
	private static partial Regex ColorBlockRegExCompiled();
