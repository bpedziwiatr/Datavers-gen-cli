...
public class BaseConnectionStringValidator
{
	...
	{
		bool isPasswordTokenFound = ValidatorTokenHelper.TryCheckIfTokenIsPresentWithValue(ConnectionStringTokens,
		...
		bool isIntegratedSecurityToken = ValidatorTokenHelper.TryCheckIfTokenIsPresentWithValue(ConnectionStringTokens,
	...
	protected KeyValuePair<string, string> CheckIfTokenIsPresentWithValue(HashSet<string> searchTokens)
	{
	...
	protected void CheckIfUrlIsPresentAndValid()
	{
		KeyValuePair<string, string> tokenFound =
			CheckIfTokenIsPresentWithValue(ConnectionStringConst.Url);
	...
	{
		CheckIfTokenIsPresentWithValue(ConnectionStringConst.UserName);
	}
}